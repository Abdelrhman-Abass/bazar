      ...
      <div className='w-full  border-[1px] px-2 py-4'>
        <div className='flex justify-between '>
          ...
          <div className='text-sm relative w-28 flex justify-end overflow-hidden'>
            ...
            }))& toast.success(`${product.title} added successfully`)} className="absolute z-20 w-[100px] text-gray-500 hover:text-gray-900 flex items-center gap-1 top-0 transform -translate-x-32 group-hover:translate-x-0 transition-transform cursor-pointer duration-500">
