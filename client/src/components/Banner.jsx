      ...
      <div className='w-screen h-[650px] relative'>
        <div style={{ transform: `translateX(-${currentSlide * 100}vw)` }}
          className="w-[400vw] h-full flex transition-transform duration-1000">
            <img className='w-screen h-full object-cover md:object-fill' src={data[0]} alt="pic0" loading='priority' />
            <img className='w-screen h-full object-cover md:object-fill' src={data[1]} alt="pic1"  />
            <img className='w-screen h-full object-cover md:object-fill' src={data[2]} alt="pic2"/>
            <img className='w-screen h-full object-cover md:object-fill' src={data[3]} alt="pic3"/>
        </div>
